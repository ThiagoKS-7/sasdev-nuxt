<template>
    <div class="bg-indigo-950 absolute px-[3em] py-[3em] rounded-[2em] w-[36vw] h-[85vh] top-[10%] left-[30%]">
        <h1 class="text-[5em] mb-[1em]">Login</h1>
        <form>
            <div class=" my-5 flex justify-between w-[400px]">
                <svg xmlns="http://www.w3.org/2000/svg" 
                height="40" viewBox="0 150 960 960" fill="white"
                width="40">
                    <path d="M140 896q-24 0-42-18t-18-42V316q0-24 18-42t42-18h680q24 0 42 18t18 42v520q0 24-18 42t-42 18H140Zm340-302L140 371v465h680V371L480 594Zm0-60 336-218H145l335 218ZM140 371v-55 520-465Z"/>
                </svg>
                <input type="email" v-model="form.email"  required class="ml-3 rounded-[0.5em] w-[80%] text-black h-[34px]" placeholder="   Enter your email">
            </div>
            ...
            <div class="my-5 flex justify-between w-[400px] ">
                ...
                <input type="password" v-model="form.password" required class="ml-3 rounded-[0.5em] w-[80%] text-black h-[34px]" placeholder="  Enter your password">
            </div>
            <div class="flex justify-end mt-[3em]">
                <button type="submit" class="submit-button" @click="loginUser()">
                    Login
                </button>
            </div>
        </form>
